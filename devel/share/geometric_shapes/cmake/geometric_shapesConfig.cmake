...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /home/ahmed2/catkin_ws/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /home/ahmed2/catkin_ws/devel)
  ...
  set(geometric_shapes_INSTALL_PREFIX /home/ahmed2/catkin_ws/install)
...
if(NOT "/home/ahmed2/catkin_ws/src/geometric_shapes/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/ahmed2/catkin_ws/src/geometric_shapes/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ahmed2/catkin_ws/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
    _list_append_unique(geometric_shapes_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "geometric_shapes;/usr/lib/x86_64-linux-gnu/liboctomap.so;/usr/lib/x86_64-linux-gnu/liboctomath.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4")
